...
class ChatAdapter(val context: Context) :
    ...
    private val messageList = ArrayList<vnd.hieunguyenUpdate.chatapp.Message>()
...
//            }
            ...
            viewHolder.img_avatar.setOnClickListener {
                val intent = Intent(context, vnd.hieunguyenUpdate.chatapp.ProfileActivity::class.java)
...
//            }
    ...
    fun updateData (newList: ArrayList<vnd.hieunguyenUpdate.chatapp.Message>) {
        val diffCallBack = vnd.hieunguyenUpdate.chatapp.MessageDiffUtil(messageList, newList)
