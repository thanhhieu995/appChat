package vnd.hieunguyenUpdate.chatapp.chat
...
import vnd.hieunguyenUpdate.chatapp.main.MainActivity
import vnd.hieunguyenUpdate.chatapp.notificationTest.NotificationData
import vnd.hieunguyenUpdate.chatapp.notificationTest.PushNotification
import vnd.hieunguyenUpdate.chatapp.notificationTest.RetrofitInstance
...
//        showTyping(messageBox)
        val messageObject = vnd.hieunguyenUpdate.chatapp.Message(
            message,
            loginUid,
            friendUid,
            currentDate,
...
//        chatAdapter.updateData(newList)
    ...
    private fun loadDataRoomSend() {
        ...
        var messageTemp: vnd.hieunguyenUpdate.chatapp.Message = vnd.hieunguyenUpdate.chatapp.Message()
        ...
        mDbRef.child("chats").child(roomSender!!).child("messages")
            .addValueEventListener(object : ValueEventListener {
                ...
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    val messageList = ArrayList<vnd.hieunguyenUpdate.chatapp.Message>()

                    var messageEXReceive: vnd.hieunguyenUpdate.chatapp.Message? = vnd.hieunguyenUpdate.chatapp.Message(
                        "",
                        "",
                        "",
                        "2019-06-06 10:10:10",
                    ...
                    var messageSender: vnd.hieunguyenUpdate.chatapp.Message? = vnd.hieunguyenUpdate.chatapp.Message(
                        "",
                        "",
                        "",
                        "2020-06-06 10:10:10",
                    ...
                    var messageExSend: vnd.hieunguyenUpdate.chatapp.Message? = vnd.hieunguyenUpdate.chatapp.Message(
                        "",
                        "",
                        "",
                        "2019-06-06 10:10:10",
                    ...
                    var messageReceive: vnd.hieunguyenUpdate.chatapp.Message? = vnd.hieunguyenUpdate.chatapp.Message(
                        "",
                        "",
                        "",
                        "2020-06-06 10:10:10",
                    ...
                    for (postSnapshot in snapshot.children) {
                        ...
                        val message = postSnapshot.getValue(vnd.hieunguyenUpdate.chatapp.Message::class.java)
...
//            return true
        ...
        if (item.itemId == R.id.action_name_title) {
            val intent = Intent(this@ChatActivity, vnd.hieunguyenUpdate.chatapp.ProfileActivity::class.java)
