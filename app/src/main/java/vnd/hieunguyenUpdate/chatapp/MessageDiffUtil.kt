...
class MessageDiffUtil(private val oldList: ArrayList<vnd.hieunguyenUpdate.chatapp.Message>, private val newList: ArrayList<vnd.hieunguyenUpdate.chatapp.Message>) : DiffUtil.Callback() {
