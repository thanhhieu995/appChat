...
import vnd.hieuUpdate.chitChat.accountLogin.SetUpActivity
...
class ProfileActivity : AppCompatActivity() {
    ...
    lateinit var userLogin: vnd.hieuUpdate.chitChat.User
    lateinit var userFriend: vnd.hieuUpdate.chitChat.User
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        userLogin = intent.getSerializableExtra("userLogin") as vnd.hieuUpdate.chitChat.User
        userFriend = intent.getSerializableExtra("userFriend") as vnd.hieuUpdate.chitChat.User
        ...
        imgProfile.setOnClickListener(View.OnClickListener {
            //popUp()
            val intent = Intent(this@ProfileActivity, vnd.hieuUpdate.chitChat.ViewProfileActivity::class.java)
