...
import vn.hieunguyen.chatapp.accountLogin.SetUpActivity
...
class ProfileActivity : AppCompatActivity() {
    ...
    lateinit var userLogin: vn.hieunguyen.chatapp.User
    lateinit var userFriend: vn.hieunguyen.chatapp.User
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        userLogin = intent.getSerializableExtra("userLogin") as vn.hieunguyen.chatapp.User
        userFriend = intent.getSerializableExtra("userFriend") as vn.hieunguyen.chatapp.User
        ...
        imgProfile.setOnClickListener(View.OnClickListener {
            //popUp()
            val intent = Intent(this@ProfileActivity, vn.hieunguyen.chatapp.ViewProfileActivity::class.java)
