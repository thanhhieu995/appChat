package vn.hieunguyen.chatapp.chat
...
import vn.hieunguyen.chatapp.notificationTest.NotificationData
import vn.hieunguyen.chatapp.notificationTest.PushNotification
import vn.hieunguyen.chatapp.notificationTest.RetrofitInstance
...
//        showTyping(messageBox)
        val messageObject = vn.hieunguyen.chatapp.Message(
            message,
            loginUid,
            friendUid,
            currentDate,
...
//        chatAdapter.updateData(newList)
    ...
    private fun loadDataRoomSend() {
        ...
        var messageTemp: vn.hieunguyen.chatapp.Message = vn.hieunguyen.chatapp.Message()
        ...
        mDbRef.child("chats").child(roomSender!!).child("messages")
            .addValueEventListener(object : ValueEventListener {
                ...
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    val messageList = ArrayList<vn.hieunguyen.chatapp.Message>()

                    var messageEXReceive: vn.hieunguyen.chatapp.Message? = vn.hieunguyen.chatapp.Message(
                        "",
                        "",
                        "",
                        "2019-06-06 10:10:10",
                    ...
                    var messageSender: vn.hieunguyen.chatapp.Message? = vn.hieunguyen.chatapp.Message(
                        "",
                        "",
                        "",
                        "2020-06-06 10:10:10",
                    ...
                    var messageExSend: vn.hieunguyen.chatapp.Message? = vn.hieunguyen.chatapp.Message(
                        "",
                        "",
                        "",
                        "2019-06-06 10:10:10",
                    ...
                    var messageReceive: vn.hieunguyen.chatapp.Message? = vn.hieunguyen.chatapp.Message(
                        "",
                        "",
                        "",
                        "2020-06-06 10:10:10",
                    ...
                    for (postSnapshot in snapshot.children) {
                        ...
                        val message = postSnapshot.getValue(vn.hieunguyen.chatapp.Message::class.java)
...
//            return true
        ...
        if (item.itemId == R.id.action_name_title) {
            val intent = Intent(this@ChatActivity, vn.hieunguyen.chatapp.ProfileActivity::class.java)
