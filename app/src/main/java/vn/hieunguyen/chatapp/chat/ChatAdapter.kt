...
class ChatAdapter(val context: Context) :
    ...
    private val messageList = ArrayList<vn.hieunguyen.chatapp.Message>()
...
//            }
            ...
            viewHolder.img_avatar.setOnClickListener {
                val intent = Intent(context, vn.hieunguyen.chatapp.ProfileActivity::class.java)
...
//            }
    ...
    fun updateData (newList: ArrayList<vn.hieunguyen.chatapp.Message>) {
        val diffCallBack = vn.hieunguyen.chatapp.MessageDiffUtil(messageList, newList)
