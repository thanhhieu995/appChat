...
class MessageDiffUtil(private val oldList: ArrayList<vn.hieunguyen.chatapp.Message>, private val newList: ArrayList<vn.hieunguyen.chatapp.Message>) : DiffUtil.Callback() {
